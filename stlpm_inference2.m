...
for n=1:size(results,2)-1; % loop over LHS variables
    ...
    results(n).NL.scaled.delta_neg=[zeros(H+1) eye(H+1)/results(end).NL.betafull(1,end) zeros(H+1,1) -results(n).NL.betafull(:,end)/(results(end).NL.betafull(1,end)^2)];  
    ...
    results(n).NL.smoothed.delta_neg=[zeros(H+1) weight/results(end).NL.betafull(1,end) zeros(H+1,1) -weight*results(n).NL.betafull(:,end)/(results(end).NL.betafull(1,end)^2)];  
    ...
    results(n).NL.cum.delta_neg=[zeros(H+1) cumweight/results(end).NL.betafull(1,end) zeros(H+1,1) -cumweight*results(n).NL.betafull(:,end)/(results(end).NL.betafull(1,end)^2)];  
...
results(end).NL.scaled.delta_neg=[zeros(H+1) eye(H+1)/results(end).NL.betafull(1,end)];
results(end).NL.scaled.delta_neg(:,H+2)=results(end).NL.scaled.delta_neg(:,H+2)-results(end).NL.betafull(:,end)/(results(end).NL.betafull(1,end)^2);
...
results(end).NL.smoothed.delta_neg=[zeros(H+1) weight/results(end).NL.betafull(1,end)];
results(end).NL.smoothed.delta_neg(:,H+2)=results(end).NL.smoothed.delta_neg(:,H+2)-weight*results(end).NL.betafull(:,end)/(results(end).NL.betafull(1,end)^2);
...
results(end).NL.cum.delta_pos(:,1)=results(end).NL.cum.delta_pos(:,1)-cumweight*results(end).NL.betafull(:,end-1)/(results(end).NL.betafull(1,end-1)^2);
results(end).NL.cum.delta_neg=[zeros(H+1) cumweight/results(end).NL.betafull(1,end)];
results(end).NL.cum.delta_neg(:,H+2)=results(end).NL.cum.delta_neg(:,H+2)-cumweight*results(end).NL.betafull(:,end)/(results(end).NL.betafull(1,end)^2);
