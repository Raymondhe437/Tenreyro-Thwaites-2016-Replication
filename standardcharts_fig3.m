function [] = standardcharts_fig3(results,varindices,chartname,filename,rownames,colnames,H,CI,CIparam,scaling)
...
set(titleh,'VerticalAlignment','bottom','HorizontalAlignment','center')
n=get(gca,'ytick');
xlim([0 20])
set(gca,'XTick', [0 10 20])
box on
...
n=get(gca,'ytick');
set(gca,'yticklabel',['-0.004';'-0.002';'     0';' 0.002';' 0.004']);
xlim([0 20])
set(gca,'XTick', [0 10 20])
box on
hold off
